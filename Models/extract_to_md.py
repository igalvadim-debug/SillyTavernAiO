...
def extract_post_text(html_content):
    ...
    for item in soup.find_all('div', class_='item'):
        # Внутри item ищем div[align="left"] — основной текст поста
        content_div = item.find('div', align='left')
        if content_div:
            # Получаем текст, сохраняя переносы
...
def main():
    ...
    for html_file in sorted(html_files):
        try:
            # Читаем в правильной кодировке Windows-1251
            ...
            for post_text in posts:
                ...
                # Если следующий блок не помещается — сохраняем файл и начинаем новый
