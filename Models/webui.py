        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                narrator_dd = gr.Dropdown(
                    label   = "Рассказчик",
                    choices = ["короткий фильм", "рассказ девушки", "рассказ парня", "рассказ старушки", "рассказ старика", "документация", "хоррор", "комедия", "скетч", "sci-fi", "боевик", "немое кино", "немое кино (фортепиано)", "детектив", "music: rock concert", "music: pop concert", "music: thai clip", "music: русский шансон", "music: latino pop", "music: latin reggaeton"],
